...
namespace Genies.Sdk.AvatarEditor.Core
{
    internal class AvatarEditingBehaviour
    {
        ...
        private IAvatarCustomizationService _AvatarCustomizationService => this.GetService<IAvatarCustomizationService>();
        ...
        private async UniTask SaveAvatarDefinition()
        {
            try
            {
                ...
                if (_saveSettings.SaveOption == AvatarSaveOption.SaveLocallyAndContinue || _saveSettings.SaveOption == AvatarSaveOption.SaveLocallyAndExit)
                {
                    ...
                    _AvatarCustomizationService.SaveAvatarDefinitionLocally(_currentCustomizedAvatar, profileId);
                }
                else
                {
                    await _AvatarCustomizationService.SaveAvatarDefinitionAsync(_currentCustomizedAvatar);
                }
